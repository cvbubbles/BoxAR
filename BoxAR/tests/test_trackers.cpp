...
void test_detectors()
{
	...
	//std::string modelFile = "D:\\projects\\boxar\\BoxAR\\scan\\vase\\obj\\qinghuaci.obj", videoFile = R"(.\scan\vase\test2.mp4)";
	//std::string  modelFile = R"(.\scan\3ds-model\plane\plane.ply)";

	std::string modelFile = R"(.\tests\model\test1\mesh.obj)", videoFile = R"(.\tests\video\test1_video\test_1_5_chest.mp4)";
	...
	VideoWriter writer("output.avi", fourcc, 30, Size(1280, 720), true);
	FrameData fd;
